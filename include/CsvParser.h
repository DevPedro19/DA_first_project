...
private:
    ...
    */
    ...
    /**
     * @brief This function is responsible for parsing a single control line of the CSV file
     * and populating the control field of the data object.
     * @param line The line from the CSV file that contains the data for a single control parameter.
     * @param data The data object that will have its control field populated with the control parameter from the line.
     */
